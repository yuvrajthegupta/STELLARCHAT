...
class EnvConfig {
    ...
    friendbot;
    admin;
    constructor(rpc, horizonRpc, passphrase, friendbot, admin) {
        this.rpc = rpc;
    ...
    static loadFromFile(network) {
        ...
        return new EnvConfig(new SorobanRpc.Server(rpc_url, { allowHttp }), new Horizon.Server(horizon_rpc_url, { allowHttp }), passphrase, friendbot_url, Keypair.fromSecret(admin));
    }
    /**
